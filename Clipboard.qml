...
Item {
  ...
  property string captureScript: root.scriptPath("capture.sh")

  // Resolves a file shipped alongside this plugin (own dir, not
  // $OMARCHY_PATH/shell/plugins/clipboard — this is an external plugin
  // symlinked into ~/.config/omarchy/plugins/, not a built-in one).
